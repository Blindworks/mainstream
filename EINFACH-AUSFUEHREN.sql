...
('admin@mainstream.app', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'Admin', 'User', '1985-03-15', 'MALE', 'EXPERT', 1, 1, 'ADMIN', 'https://ui-avatars.com/api/?name=Admin+User&background=e91e63&color=fff&size=128', 'Plattform Administrator', 'KILOMETERS', NOW(), NOW()),
('test.mueller@mainstream.app', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'Max', 'Müller', '1990-06-20', 'MALE', 'INTERMEDIATE', 1, 1, 'USER', 'https://ui-avatars.com/api/?name=Max+Mueller&background=9c27b0&color=fff&size=128', 'Laufe gerne am Main', 'KILOMETERS', NOW(), NOW()),
('test.schmidt@mainstream.app', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'Anna', 'Schmidt', '1988-11-12', 'FEMALE', 'ADVANCED', 1, 1, 'USER', 'https://ui-avatars.com/api/?name=Anna+Schmidt&background=673ab7&color=fff&size=128', 'Marathon-Läuferin', 'KILOMETERS', NOW(), NOW()),
('test.weber@mainstream.app', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'Tim', 'Weber', '1995-02-28', 'MALE', 'INTERMEDIATE', 1, 1, 'USER', 'https://ui-avatars.com/api/?name=Tim+Weber&background=3f51b5&color=fff&size=128', 'Morgenläufer', 'KILOMETERS', NOW(), NOW()),
('test.wagner@mainstream.app', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'Sarah', 'Wagner', '1992-09-05', 'FEMALE', 'ADVANCED', 1, 1, 'USER', 'https://ui-avatars.com/api/?name=Sarah+Wagner&background=2196f3&color=fff&size=128', 'Trail-Running Fan', 'KILOMETERS', NOW(), NOW()),
('test.becker@mainstream.app', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'Jan', 'Becker', '1987-04-17', 'MALE', 'BEGINNER', 1, 1, 'USER', 'https://ui-avatars.com/api/?name=Jan+Becker&background=03a9f4&color=fff&size=128', 'Hobbyjogger', 'KILOMETERS', NOW(), NOW()),
('test.hoffmann@mainstream.app', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'Lisa', 'Hoffmann', '1993-07-22', 'FEMALE', 'INTERMEDIATE', 1, 1, 'USER', 'https://ui-avatars.com/api/?name=Lisa+Hoffmann&background=00bcd4&color=fff&size=128', 'Laufen ist Meditation', 'KILOMETERS', NOW(), NOW()),
('test.koch@mainstream.app', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'Tom', 'Koch', '1991-01-30', 'MALE', 'INTERMEDIATE', 1, 1, 'USER', 'https://ui-avatars.com/api/?name=Tom+Koch&background=009688&color=fff&size=128', 'Stadtpark-Läufer', 'KILOMETERS', NOW(), NOW()),
('test.richter@mainstream.app', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'Emma', 'Richter', '1994-12-08', 'FEMALE', 'BEGINNER', 1, 1, 'USER', 'https://ui-avatars.com/api/?name=Emma+Richter&background=4caf50&color=fff&size=128', 'Neue Läuferin', 'KILOMETERS', NOW(), NOW()),
('test.klein@mainstream.app', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'Lukas', 'Klein', '1989-08-14', 'MALE', 'EXPERT', 1, 1, 'USER', 'https://ui-avatars.com/api/?name=Lukas+Klein&background=8bc34a&color=fff&size=128', 'Ultra-Marathon', 'KILOMETERS', NOW(), NOW()),
('test.wolf@mainstream.app', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'Sophie', 'Wolf', '1996-05-25', 'FEMALE', 'INTERMEDIATE', 1, 1, 'USER', 'https://ui-avatars.com/api/?name=Sophie+Wolf&background=cddc39&color=fff&size=128', 'Charity-Läuferin', 'KILOMETERS', NOW(), NOW()),
('test.neumann@mainstream.app', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'Felix', 'Neumann', '1990-10-03', 'MALE', 'ADVANCED', 1, 1, 'USER', 'https://ui-avatars.com/api/?name=Felix+Neumann&background=ffc107&color=fff&size=128', 'Intervalltraining', 'KILOMETERS', NOW(), NOW()),
('test.schwarz@mainstream.app', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'Laura', 'Schwarz', '1997-03-19', 'FEMALE', 'INTERMEDIATE', 1, 1, 'USER', 'https://ui-avatars.com/api/?name=Laura+Schwarz&background=ff9800&color=fff&size=128', 'Daily Runner', 'KILOMETERS', NOW(), NOW()),
('test.zimmermann@mainstream.app', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'Ben', 'Zimmermann', '1986-11-27', 'MALE', 'INTERMEDIATE', 1, 1, 'USER', 'https://ui-avatars.com/api/?name=Ben+Zimmermann&background=ff5722&color=fff&size=128', 'Abendläufer', 'KILOMETERS', NOW(), NOW()),
('test.fischer@mainstream.app', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'Marie', 'Fischer', '1992-06-11', 'FEMALE', 'ADVANCED', 1, 1, 'USER', 'https://ui-avatars.com/api/?name=Marie+Fischer&background=795548&color=fff&size=128', 'Naturliebhaberin', 'KILOMETERS', NOW(), NOW()),
('test.meyer@mainstream.app', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'Paul', 'Meyer', '1988-09-01', 'MALE', 'EXPERT', 1, 1, 'USER', 'https://ui-avatars.com/api/?name=Paul+Meyer&background=607d8b&color=fff&size=128', 'Wettkampf-Läufer', 'KILOMETERS', NOW(), NOW());
